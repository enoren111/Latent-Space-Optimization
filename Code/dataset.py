...
class FGSBIR_Dataset(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        if self.mode == 'Train':
            ...
            positive_tag = float(positive_sample)
            sketch_tag = float(positive_sample)
            negative_tag = float(negative_sample)
            ...
            sample = {'sketch_img': sketch_img, 'sketch_path': sketch_path, 'sketch_tag': sketch_tag,
                      'positive_img': positive_img, 'positive_path': positive_sample, 'positive_tag': positive_tag,
                      'negative_img': negative_img, 'negative_path': negative_sample, 'negative_tag': negative_tag
                      }
